...
/**
 * This is the model class for table "tutorsubject".
 *
 * The followings are the available columns in table 'tutorsubject':
 * @property string $id
 ...
 */
class TutorSubject extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            array('tutorId, dictSubjectId', 'required'),
            array('tutorId, dictSubjectId', 'length', 'max' => 10),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('id, tutorId, dictSubjectId', 'safe', 'on' => 'search'),
        );
    }
     ...
     * @return TutorSubject the static model class
     */
