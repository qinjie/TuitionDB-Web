...
class TbHtmlTest extends TbTestCase {
    ...
    public function testForm() {
        $I = $this->codeGuy;
        $html = TbHtml::formTb(
                        TbHtml::FORM_LAYOUT_VERTICAL, '#', 'post', array(
                    'class' => 'form',
                        )
        );
    ...
    public function testUrlField() {
        ...
        $html = TbHtml::urlField(
                        'url', 'http://www.getyiistrap.com', array(
                    'class' => 'input',
                        )
        );
    ...
    public function testEmailField() {
        ...
        $html = TbHtml::emailField(
                        'email', 'christoffer.niska@gmail.com', array(
                    'class' => 'input',
                        )
        );
    ...
    public function testDropDownList() {
        ...
        $html = TbHtml::dropDownList(
                        'dropdown', null, array('1', '2', '3', '4', '5'), array(
                    'class' => 'list',
                    'empty' => 'Empty text',
    ...
    public function testListBox() {
        ...
        $html = TbHtml::listBox(
                        'listbox', null, array('1', '2', '3', '4', '5'), array(
                    'class' => 'list',
                    'empty' => 'Empty text',
                    'size' => TbHtml::INPUT_SIZE_LARGE,
                    'textAlign' => TbHtml::TEXT_ALIGN_CENTER,
    ...
    public function testRadioButtonList() {
        ...
        $html = TbHtml::radioButtonList(
                        'radioList', null, array('Option 1', 'Option 2', 'Option 3'), array(
                    'separator' => '<br>',
                    'container' => 'div',
    ...
    public function testInlineRadioButtonList() {
        ...
        $html = TbHtml::inlineRadioButtonList(
                        'radioList', null, array('Option 1', 'Option 2', 'Option 3')
        );
    ...
    public function testCheckboxList() {
        ...
        $html = TbHtml::checkBoxList(
                        'checkboxList', null, array('Option 1', 'Option 2', 'Option 3'), array(
                    'separator' => '<br>',
                    'container' => 'div',
                    'containerOptions' => array('class' => 'container'),
                        )
        ...
        $span = $I->createNode($html, 'span');
        $I->seeNodeChildren(
                $span, array('input[type=checkbox]', 'label.checkbox', 'label.checkbox', 'label.checkbox', 'label.checkbox')
        );
        ...
        $span = $I->createNode($html, 'span');
        $I->seeNodeChildren(
                $span, array('label.checkbox', 'label.checkbox', 'label.checkbox', 'label.checkbox', 'input[type=checkbox]')
        );
    ...
    public function testInlineCheckBoxList() {
        ...
        $html = TbHtml::inlineCheckBoxList(
                        'checkboxList', null, array('Option 1', 'Option 2', 'Option 3')
        );
        $span = $I->createNode($html, 'span');
        $I->seeNodeNumChildren($span, 3);
        $I->seeNodeChildren(
                $span, array('label.checkbox.inline', 'label.checkbox.inline', 'label.checkbox.inline')
        );
    }
    ...
    public function testRadioButtonListControlGroup() {
        ...
        $html = TbHtml::radioButtonListControlGroup(
                        'radioList', '1', array('Option 1', 'Option 2', 'Option 3')
        );
        $group = $I->createNode($html, 'div.control-group');
        $controls = $group->filter('div.controls');
    ...
    public function testCheckBoxListControlGroup() {
        ...
        $html = TbHtml::checkBoxListControlGroup(
                        'checkboxList', array('0', '2'), array('Option 1', 'Option 2', 'Option 3')
        );
        $group = $I->createNode($html, 'div.control-group');
        $controls = $group->filter('div.controls');
    ...
    public function testInlineCheckBoxListControlGroup() {
        ...
        $controls = $group->filter('div.controls');
        $I->seeNodeChildren(
                $controls, array('label.checkbox.inline', 'label.checkbox.inline', 'label.checkbox.inline')
        );
    }
    ...
    public function testControlGroup() {
        ...
        $html = TbHtml::controlGroup(
                        TbHtml::INPUT_TYPE_TEXT, 'text', '', array(
        ...
        $html = TbHtml::controlGroup(
                        TbHtml::INPUT_TYPE_RADIOBUTTON, 'radio', true, array(
                    'label' => 'Label text',
                        )
        );
        $group = $I->createNode($html, 'div.control-group');
    ...
    public function testCustomControlGroup() {
        ...
        $html = TbHtml::customControlGroup(
                        '<div class="widget"></div>', 'custom', array(
                    'label' => false,
                        )
        );
        $group = $I->createNode($html, 'div.control-group');
    ...
    public function testActiveDropDownList() {
        ...
        $html = TbHtml::activeDropDownList(
                        new Dummy, 'dropdown', array('1', '2', '3', '4', '5'), array(
                    'class' => 'list',
                    'empty' => 'Empty text',
                    'size' => TbHtml::INPUT_SIZE_LARGE,
                    'textAlign' => TbHtml::TEXT_ALIGN_CENTER,
    ...
    public function testActiveListBox() {
        ...
        $html = TbHtml::activeListBox(
                        new Dummy, 'listbox', array('1', '2', '3', '4', '5'), array(
                    'class' => 'list',
                    'empty' => 'Empty text',
                    'size' => TbHtml::INPUT_SIZE_LARGE,
                    'textAlign' => TbHtml::TEXT_ALIGN_CENTER,
    ...
    public function testActiveRadioButtonList() {
        ...
        $html = TbHtml::activeRadioButtonList(
                        new Dummy, 'radioList', array('Option 1', 'Option 2', 'Option 3')
        );
        $body = $I->createNode($html);
        $I->seeNodeChildren(
                $body, array('input[type=hidden]', 'label.radio', 'label.radio', 'label.radio')
        );
    ...
    public function testActiveCheckBoxList() {
        ...
        $html = TbHtml::activeCheckBoxList(
                        new Dummy, 'checkboxList', array('Option 1', 'Option 2', 'Option 3')
        );
        $container = $I->createNode($html);
        $I->seeNodeChildren(
                $container, array('input[type=hidden]', 'label.checkbox', 'label.checkbox', 'label.checkbox')
        );
        $label = $container->filter('label')->first();
        $I->seeNodePattern($label, '/> Option 1$/');
        $input = $label->filter('input[type=checkbox]');
    ...
    public function testActiveInlineCheckBoxList() {
        ...
        $container = $I->createNode($html);
        $I->seeNodeChildren(
                $container, array('label.checkbox.inline', 'label.checkbox.inline', 'label.checkbox.inline')
        );
    }
    ...
    public function testActiveDropDownListControlGroup() {
        ...
        $html = TbHtml::activeDropDownListControlGroup(
                        new Dummy, 'dropdown', array('1', '2', '3', '4', '5')
        );
        $group = $I->createNode($html, 'div.control-group');
        $controls = $group->filter('div.controls');
        $I->seeNodeChildren($controls, array('select'));
    ...
    public function testActiveListBoxControlGroup() {
        ...
        $html = TbHtml::activeListBoxControlGroup(
                        new Dummy, 'listbox', array('1', '2', '3', '4', '5')
        );
        $group = $I->createNode($html, 'div.control-group');
        $controls = $group->filter('div.controls');
        $I->seeNodeChildren($controls, array('select'));
    ...
    public function testActiveInlineRadioButtonListControlGroup() {
        ...
        $controls = $group->filter('div.controls');
        $I->seeNodeChildren(
                $controls, array('input[type=hidden]', 'label.radio.inline', 'label.radio.inline', 'label.radio.inline')
        );
    }
    ...
    public function testActiveCheckBoxListControlGroup() {
        ...
        $html = TbHtml::activeCheckBoxListControlGroup(
                        new Dummy, 'checkboxList', array('0', '2'), array('Option 1', 'Option 2', 'Option 3')
        );
        $group = $I->createNode($html, 'div.control-group');
        $controls = $group->filter('div.controls');
        $I->seeNodeChildren(
                $controls, array('input[type=hidden]', 'label.checkbox', 'label.checkbox', 'label.checkbox')
        );
    }
    ...
    public function testActiveInlineCheckBoxListControlGroup() {
        ...
        $controls = $group->filter('div.controls');
        $I->seeNodeChildren(
                $controls, array('input[type=hidden]', 'label.checkbox.inline', 'label.checkbox.inline', 'label.checkbox.inline')
        );
    }
    ...
    public function testActiveControlGroup() {
        ...
        $html = TbHtml::activeControlGroup(
                        TbHtml::INPUT_TYPE_TEXT, new Dummy, 'text', array(
        ...
        $html = TbHtml::activeControlGroup(
                        TbHtml::INPUT_TYPE_RADIOBUTTON, new Dummy, 'radio', array(
                    'labelOptions' => array('class' => 'label'),
                        )
        );
        $group = $I->createNode($html, 'div.control-group');
    ...
    public function testActiveCustomControlGroup() {
        ...
        $html = TbHtml::customActiveControlGroup(
                        '<div class="widget"></div>', new Dummy, 'text', array(
                    'label' => false,
                        )
        );
        $group = $I->createNode($html, 'div.control-group');
    ...
    public function testErrorSummary() {
        ...
        $html = TbHtml::errorSummary(
                        $model, 'Header text', 'Footer text', array(
                    'class' => 'summary'
                        )
        );
    ...
    public function testControls() {
        ...
        $html = TbHtml::controls(
                        '<div class="control"></div><div class="control"></div>', array(
                    'before' => 'Before text',
                    'after' => 'After text',
                        )
        );
    ...
    public function testFormActions() {
        ...
        $this->assertEquals(
                '<div class="form-actions"><div class="action"></div><div class="action"></div></div>', $html
        );
    ...
    public function testAjaxLink() {
        ...
        $html = TbHtml::ajaxLink(
                        'Link', '#', array(), // todo: figure out a way to test the ajax options as well.
                        array(
                    'id' => 'button',
                    'class' => 'button',
                        )
    ...
    public function testImageRounded() {
        ...
        $html = TbHtml::imageRounded(
                        'image.png', 'Alternative text', array(
                    'class' => 'image',
                        )
        );
    ...
    public function testTabbable() {
        ...
        $html = TbHtml::tabbable(
                        TbHtml::NAV_TYPE_NONE, $tabs, array(
                    'class' => 'div',
                        )
        );
        $tabbable = $I->createNode($html, 'div.tabbable');
    ...
    public function testHeroUnit() {
        ...
        $html = TbHtml::heroUnit(
                        'Heading text', 'Content text', array(
                    'class' => 'div',
    ...
    public function testAlert() {
        ...
        $html = TbHtml::alert(
                        TbHtml::ALERT_COLOR_SUCCESS, 'Alert message', array(
                    'class' => 'div',
                    'closeText' => 'Close',
        ...
        $html = TbHtml::alert(
                        TbHtml::ALERT_COLOR_INFO, 'Alert message', array(
                    'closeText' => false,
                    'in' => false,
                    'fade' => false,
                        )
    ...
    public function testMedia() {
        ...
        $html = TbHtml::media(
                        'image.png', 'Heading text', 'Content text', array(
                    'class' => 'div',
                    'linkOptions' => array('class' => 'link'),
                    'imageOptions' => array('class' => 'image', 'alt' => 'Alternative text'),
    ...
    public function testPopover() {
        ...
        $html = TbHtml::popover(
                        'Link', 'Heading text', 'Content text', array(
                    'class' => 'link',
                        )
        );
    ...
    public function testCarouselItem() {
        ...
        $html = TbHtml::carouselItem(
                        'Content text', 'Label text', 'Caption text', array(
                    'class' => 'div',
    ...
    public function testAddCssStyle() {
        ...
        $this->assertEquals(
                'display: none; color: purple; background: #fff; font-family: "Open sans"; font-weight: bold', $htmlOptions['style']
        );
    }
